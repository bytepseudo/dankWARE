...
local Window = dankWARE.Utilities.Interface:Window({Name = 'dankWARE', Enabled = true, Color = Color3.new(0.0902, 0.65098, 0.92941, 0), Size = UDim2.new(0,496,0,496), Position = UDim2.new(0.5,-248,0.5,-248)}) do
    local CombatTab = Window:Tab({Name = 'Combat'}) do
        ...
        local ModificationSection = CombatTab:Section({Name = 'Modification', Side = 'Left'}) do
            ModificationSection:Toggle({Name = 'Unlock Firemodes', Flag = 'Combat/Modification/UnlockFiremodes', Value = false})
            ModificationSection:Toggle({Name = 'No Spread', Flag = 'Combat/Modification/NoSpread', Value = false})
            ModificationSection:Toggle({Name = 'Rate of Fire', Flag = 'Combat/Modification/RPMEnabled', Value = false})
            ModificationSection:Slider({Name = 'Rate', Flag = 'Combat/Modification/RPM', Min = 0, Max = 5000, Value = 1000, Precise = 1, Unit = ''})
        end
